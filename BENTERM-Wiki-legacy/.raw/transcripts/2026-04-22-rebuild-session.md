...
# BENTERM Rebuild Session Summary

The rebuild starts from upstream WezTerm and keeps BENTERM changes small and reviewable.
...
The Windows notification system uses upstream OSC 9 / OSC 777 terminal notifications. BENTERM adds click-to-focus routing so a notification click focuses the pane/window that emitted it. It also adds a brief cyan border pulse to make the focused terminal visually obvious.
