...
Tab Attention Indicator marks the tab that emitted an agent-ready notification. It is needed because a user may run multiple Codex or Claude sessions as tabs inside one BENTERM window instead of separate OS windows.
