...
BENTERM's public GitHub banner is a release-facing asset, not a scratch artifact.
...
As of 2026-04-23, the public README banner is an approved refined BENTERM WebP variant promoted from the local candidate workflow into `assets/banner.webp`.
