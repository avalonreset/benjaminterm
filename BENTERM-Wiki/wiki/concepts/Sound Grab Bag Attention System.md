...
BENTERM uses soft randomized sound cues as part of its sensory workflow layer for vibe coding. The intent is not to make notifications loud. The intent is to let different terminal windows acquire subtle audible identity during long multi-window coding sessions.
...
- Sound pack path: `assets/sounds/benterm-soft-cues/`
