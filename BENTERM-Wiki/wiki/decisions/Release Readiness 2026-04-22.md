...
BENTERM is ready to push as a release candidate, but it is not an official three-platform release until GitHub Actions successfully builds and uploads Windows, Linux, and macOS artifacts.
