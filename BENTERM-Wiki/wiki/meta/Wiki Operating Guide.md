...
- Open `<repo-root>\BENTERM-Wiki` as the vault root.
...
```text
Use the codex-obsidian skill. Read BENTERM-Wiki/wiki/hot.md and BENTERM-Wiki/wiki/index.md first, then update the smallest relevant note. Keep hot, index, and log current.
```
