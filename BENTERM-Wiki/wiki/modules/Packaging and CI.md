...
Packaging and CI now target BENTERM-branded release artifacts.

## Required GitHub Release Artifacts

- Windows: `BENTERM-*.zip`, `BENTERM-*.exe`, checksums.
- macOS: `BENTERM-macos-*.zip`, checksums.
- Linux: `benterm-*.deb`, `benterm-*.rpm`, `benterm-*.tar.xz`, source archive, AppImage, checksums.
