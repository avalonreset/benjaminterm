# BENTERM Rebuild Plan

Baseline: WezTerm upstream `origin/main` at `577474d89` on 2026-04-21.

Current rebuild branch: `benterm-rebuild-2026-04-21`.

## Ground Rules

- Start from clean upstream WezTerm and apply BENTERM changes in small, reviewable commits.
...
- Keep WezTerm remotes separate: `origin` is upstream WezTerm, `fork` is BENTERM.

## Candidate Feature Groups

1. Branding
   - BENTERM name and runtime identity.
   - BENTERM icons and Windows installer branding.
...
Old BENTERM branch: `fork/main` at `67bfb13da`.
