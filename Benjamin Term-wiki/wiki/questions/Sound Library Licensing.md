...
- Installed `C:/Program Files/BenjaminTerm/sounds/benjaminterm-soft-cues`: 84 WAV files.
- Installed `C:/Program Files/BenjaminTerm/sounds/kenney-interface`: absent.
