...
- `RELEASING_BENJAMINTERM.md`: release checklist and publishing policy.
- `RELEASE_NOTES_BENJAMINTERM.md`: draft release notes.
- `BENJAMINTERM_SUMMARY.txt`: project summary and positioning.
