...
$packageName = "benterm-windows-$TagName"
...
$requiredFiles = @(
  @{ Source = "wezterm.exe"; Destination = "benterm.exe" },
  @{ Source = "wezterm-gui.exe"; Destination = "benterm-gui.exe" },
  @{ Source = "wezterm-mux-server.exe"; Destination = "benterm-mux-server.exe" },
